...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Login - Smart Academic System</title>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="<?php echo base_url(); ?>assets/dist/css/ace.min.css" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="dist/css/ace-part2.min.css" />
		<![endif]-->
		<link rel="stylesheet" href="<?php echo base_url(); ?>assets/dist/css/ace-rtl.min.css" />
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">SAS</span>
									<span class="white" id="id-text2">Academic System</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; restasolution</h4>
							</div>
